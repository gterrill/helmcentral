...
export function NestedWaypoints() {
  return (
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  ...
                  <SidebarMenuSub>
                    ...
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton href="#">Rounding the Point</SidebarMenuSubButton>
                    </SidebarMenuSubItem>
                    <SidebarMenuSubItem>
                      <SidebarMenuSubButton href="#">Arrive Bay Anchorage</SidebarMenuSubButton>
                    </SidebarMenuSubItem>
                  </SidebarMenuSub>
                </SidebarMenuItem>
              </SidebarMenu>

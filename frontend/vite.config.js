...
var apiProxyTarget = process.env.VITE_API_PROXY_TARGET || 'http://localhost:8080';
                        ...
                        groups: [
                            {
                                ...
                                priority: 20,
                                test: function (id) { return id === '\0vite/preload-helper.js'; },
                            },
                            {
                                name: 'react-vendor',
                                priority: 10,
                            ...
                            },
                            {
                                ...
                                priority: 8,
                                test: function (id) {
                                    return id.includes('maplibre-gl') ||
                            ...
                            },
                            {
                                ...
                                priority: 6,
                                test: function (id) {
                                    return id.includes('react-grid-layout') ||
                            ...
                            },
                            {
                                ...
                                name: 'chart-vendor',
                                priority: 5,
                                test: function (id) { return id.includes('recharts'); },
                            },
                            {
                                name: 'markdown-vendor',
                                priority: 4,
                                test: function (id) {
                                    return id.includes('react-markdown') ||
                            ...
                            },
                            {
                                ...
                                priority: 2,
                                test: function (id) {
                                    return id.includes('lucide-react') ||
                                        id.includes('clsx') ||

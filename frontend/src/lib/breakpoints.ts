...
// Tailwind's stock `sm`/`md`/`lg` screens. Nothing in src/index.css's @theme
// block overrides them, so these are the values Tailwind's own `sm:`/`md:`/
// `lg:` prefixes compile to — keep them in sync with Tailwind if that ever
// changes.

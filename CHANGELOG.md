...
- If Mate runs out of research steps on a hard question after checking
  several documents or data sources, and its last attempt at an answer
  comes back with nothing usable, the conversation now shows a clear
  failure instead of an empty reply.

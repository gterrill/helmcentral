...
- Off-boat messages (ntfy, email, webhook) stay in SI with the unit. Operator units there need a unit table in Go, and only the two derived pressure units would use it today. Deferred.

...
- **The anchor drag klaxon has not yet been migrated onto this engine.** Until it is, two alarm paths coexist: the general one, and the browser-tab-only anchor alarm with its known bug that un-silencing never restarts the klaxon.
